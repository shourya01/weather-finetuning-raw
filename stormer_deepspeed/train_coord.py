...
from stormer_specific_data_utils import WeatherEnergySetWithCoords
...
def get_dataset(args = None, splits = [0.8,0.1,0.1]):
    ...
    building_coords_np = energy_ds.variables["building_coord"][:]
    ...
    val_dset = WeatherEnergySetWithCoords(
        lookback = args.lookback,
        lookahead = args.lookahead,
        energy_np = energy_np,
        building_coords_np = building_coords_np,
    ...
    test_dset = WeatherEnergySetWithCoords(
        lookback = args.lookback,
        lookahead = args.lookahead,
        energy_np = energy_np,
        building_coords_np = building_coords_np,
        ...
        for candidate_lr in args.lr_candidates:
            ...
            for epoch in range(args.val_epochs):
                _ = train_one_epoch(
                    ...
                    epoch = epoch,
                    two_args_for_model = args.use_weather
                )
