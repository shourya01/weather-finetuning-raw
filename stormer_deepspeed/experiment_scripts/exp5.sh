...
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp5.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --lr 5e-6 --lora_rank 4 --dataset_name illinois --experiment_name exp5_illi_timesfm_only
# Done
