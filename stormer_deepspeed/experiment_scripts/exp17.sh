...
#PBS -A ParaLLMs
#PBS -N illi-tfm-only-redo
#PBS -q prod
#PBS -l select=10
#PBS -l filesystems=home:eagle
#PBS -l walltime=03:00:00
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp17.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --lr 2e-7 --lora_rank 4 --dataset_name illinois --experiment_name exp17_illi_timesfm_only_redo
# Done
