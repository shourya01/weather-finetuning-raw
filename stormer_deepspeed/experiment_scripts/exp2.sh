...
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp2.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --tuning --lr_candidates 1e-4,5e-5,1e-5,5e-6 --lora_rank 16 --experiment_name exp2_lr_test_rank_8
