...
#PBS -A ParaLLMs
#PBS -N illi-tfm-parallel-redo
#PBS -q prod
#PBS -l select=10
#PBS -l filesystems=home:eagle
#PBS -l walltime=03:00:00
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp14.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    ...
    --dataset_name illinois --use_weather --experiment_name exp13_illi_tfm_parallel_redo
# Done
