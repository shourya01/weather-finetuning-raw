...
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp4.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --lr 5e-6 --lora_rank 4 --dataset_name california --experiment_name exp4_cali_timesfm_only
# Done
