...
#PBS -A ParaLLMs
#PBS -N cali-tfm-stormer
#PBS -q prod
#PBS -l select=10
#PBS -l filesystems=home:eagle
#PBS -l walltime=03:00:00
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp7.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --tuning --lr_candidates 5e-4,1e-4,5e-5,1e-5,5e-6,1e-6,5e-7 --lora_rank 4 \
    --dataset_name california --use_weather --experiment_name exp7_cali_timesfm_stormer
# Done
