...
#PBS -A ParaLLMs
#PBS -N mixed-tfm-only
#PBS -q prod
#PBS -l select=10
#PBS -l filesystems=home:eagle
#PBS -l walltime=03:00:00
#PBS -j oe
#PBS -o /home/shourya01/stormer_deepspeed/exp6.log
...
mpiexec --verbose --envall -n ${TOTAL_GPUS} -ppn ${GPUS_PER_NODE} --hostfile="${PBS_NODEFILE}"\
    python train.py --deepspeed --lr 5e-6 --lora_rank 4 --dataset_name mixed --experiment_name exp6_mixed_timesfm_only
# Done
